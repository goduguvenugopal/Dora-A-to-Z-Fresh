...
const OrderCheckOut = () => {
  ...
  const emailData = {
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
      ...
      Below are your shipping and order details:</p>

      <h3 style="margin-top:20px; color:#2c5282;">📦 Shipping Address</h3>
      ...
      <p style="color:#b83280; font-size:14px; margin-top:10px;">
        <strong>Note:</strong> Orders will be processed only after full payment.  
        Please send the payment receipt via WhatsApp at <a href="https://wa.me/919603669236">9603669236</a>.
      </p>

      <h3 style="margin-top:20px; color:#2c5282;">🏬 Dora A to Z Fresh Address</h3>
      <ul style="list-style:none; padding:0;">
        <li><strong>Mobile:</strong> <a href="tel:+91${number}">${number}</a></li>
        <li><strong>Address:</strong> Noori Majid Opposite, Pathabazar, Gopalpet Road, Wanaparthy 509103</li>
