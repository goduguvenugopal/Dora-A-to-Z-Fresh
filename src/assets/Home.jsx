        ...
        <>
            ...
            {toggle
                ...
                <div className="bg-black fixed  flex p-3  justify-center items-center lg:items-start top-0 left-0 h-full w-full bg-opacity-50 z-10" >
                    <div className="bg-white  p-1 text-center relative scrollbar-hide-card h-[60%] md:h-[70%] lg:h-full lg:w-[50%] overflow-auto rounded pb-5">

                        <span onClick={removePopUp} className="absolute bg-black hover:bg-black bg-opacity-65 text-white rounded w-8 h-8 flex justify-center items-center font-medium top-1 right-1 cursor-pointer"><MdClose size={25} /></span>
                        <div className="w-full h-fit bg-white rounded ">
                            <img src={images[lastImg]} alt="offer-poster" className="w-full h-fit rounded" />
                        </div>
                        <p className="mt-3 mx-2 capitalize font-serif">{carousel?.offerTitle}</p>
